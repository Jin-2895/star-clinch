    ...
    <div className="w-screen flex flex-col justify-start overflow-hidden">
      ...
      <div className="flex flex-col  px-[48px] py-[28px] ">
        ...
        <div className="bg-gradient-to-b from-[rgba(119,138,189,1)] to-[rgba(255,255,255,0)] p-[2px] rounded-[100px] w-full ">
          <div className="rounded-[100px] p-[56px] bg-[#07070e] bg-gradient-to-b from-[rgba(20,20,41,1)] to-[rgba(0,0,0,0)]  w-full">
            <div className="flex gap-8">
              <div className=" max-w-[459px] max-h-[730px] w-full overflow-hidden">
                <img src={ZakirKhanImg} className="  object-fill " />
              </div>
              <div className="flex flex-col  justify-center  gap-20 w-full max-h-[731.61px] overflow-hidden">
                    ...
                    {activeStep === 2 && (
                      <div className="mt-14">
                        ...
                        <div className="flex flex-col items-center py-10 gap-8">
                          <button
                            className="px-20 rounded-2xl bg-gradient-to-br from-[rgba(255,227,226,0.8)] via-[rgba(241,102,51,0.8)] to-[rgba(253,45,125,0.8)]"
      ...
      {open && (
        <div className="fixed inset-0 z-50 flex items-center justify-center">
          ...
          <div className="relative bg-[rgba(13,13,19,1)] rounded-[50px]  p-8 border-[1px] border-[rgba(255,255,255,0.11)] max-w-[537px] ">
