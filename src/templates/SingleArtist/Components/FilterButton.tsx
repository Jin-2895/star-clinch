...
const FilterButton = (props: Props) => {
  return (
    <div className="bg-gradient-to-tr from-gray-700 via-transparent to-gray-700 p-px rounded-full">
      <button className=" inline-flex items-center justify-between gap-4 rounded-full px-12 py-3 text-nowrap shadow-lg bg-gradient-to-tr from-black via-gray-900 to-black">
