    ...
    <div className="flex flex-col gap-4 my-6 ">
      ...
      <div className="h-[294px] w-full relative">
        <Image
          height={800}
          width={800}
          src="/assets/mobilecircle2.png"
          alt="mobilecircle2.png"
          className="absolute left-0 bottom-0 max-h-[200px] max-w-[200px]"
        />

        <Image
          height={800}
          width={800}
          src="/assets/mobilerightcircle.png"
          alt="mobilecircle3.png"
          className="absolute right-0 z-10 bottom-0 max-h-[200px] max-w-[200px]"
        />
