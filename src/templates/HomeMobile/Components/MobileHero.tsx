            ...
            <div className="flex flex-row gap-1 w-fit">
              ...
              <div className="flex flex-row items-end justify-between  ">
                <div className="flex relative flex-col gap-2">
                  ...
                  height={400}
                  width={400}
                    className="absolute z-40 top-[142px] right-[63%]"
                    src="/assets/Star 5.png"
                    alt=""
                  />
                  <Image
                  height={400}
                  width={400}
                    className="absolute z-40 top-[152px] right-[69%]"
                  ...
                  height={400}
                  width={400}
                    className="absolute z-50 top-[197px] right-[77%] "
                    src="/assets/STARCLINCH.png"
                    alt=""
                  />
                  <Image
                  height={400}
                  width={400}
                    className="absolute z-40 top-[220px] right-[69%]"
