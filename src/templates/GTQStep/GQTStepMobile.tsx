...
<div className='py-7  px-5 flex items-start justify-start'>
<h1 className="text-xs font-thin text-white" style={{ opacity: '0.5' }}>
            All Categories {'>'} Comedians {'>'} Zakir Khan
      </h1>
</div>
<div className='bg-gradient-to-b  from-[rgba(119,138,189,1)] to-[rgba(255,255,255,0)] p-[1px] rounded-[16px] w-full '>
  <div className='rounded-[16px]  px-[24px] pt-[24px] pb-[32px] bg-[#07070e]   w-full'>
    <div  className='max-w-[342px] relative  rounded-none  max-h-[195px] w-full '>
    <div className="w-full  rounded-t-[16px] absolute z-10"
        style={{
          backgroundImage: "url(/celebrities/zakirKhan.jpeg)",
          backgroundSize: "cover",
          backgroundPosition: "center",
          minHeight: "195px",
          boxShadow: "0px -100px 100px rgba(10,10,20,1) inset",
        }}
      ></div>
    </div>
    <div className='w-full mt-52 flex flex-col justify-center items-center gap-2 '>
      <p className='font-semibold text-[24px] leading-[29px] text-white '>You made a great choice !</p>
      <p className='text-white opacity-50 text-xs'>Just a step away from booking your dream star</p>
    </div>
    <div className="w-full   py-20 ">
                  <Stepper
                    ...
                    <Step
                        ...
                        placeholder=""
                        >
                      <div className="absolute right-[-2rem] top-[-2rem] w-max text-center">
                        <Typography
                    ...
                    <Step onClick={() => setActiveStep(1)} placeholder="">
                      <div className="absolute top-[-2rem] right-[-2rem]  w-max text-center">
                        <Typography
                          className='text-xs font-medium'
                            variant="h6"
                    ...
                    <Step onClick={() => setActiveStep(2)} placeholder={undefined}>
                      <div className="absolute top-[-2rem] right-[-5px] w-max text-center">
                        <Typography
                        className='text-xs font-medium'
                      ...
                      <form>
                        <div className="grid grid-cols-1 gap-6">
                          <div className="flex flex-col gap-4">
                            <label
                              className="text-white opacity-50 text-md leading-[21.78px]"
                              htmlFor="occasion"
                            >
                              What&apos;s the occasion?
                            </label>
                            <input
                              ...
                              className="input-field px-5 py-4 rounded-md bg-[#111119] text-sm leading-[29.05px] text-white opacity-80"
                            />
                          </div>
                          <div className="flex flex-col gap-4">
                            <label
                          ...
                          <div className="flex flex-col gap-4">
                            ...
                            <input
                              id="attendees"
                              type="text"
                              className="input-field px-5 py-3 rounded-md bg-[#111119] text-sm leading-[29.05px] text-white opacity-80"
                            />
                          </div>
                          <div className="flex flex-col gap-4">
                            <label
                    ...
                    <div className="mt-14">
                      <form>
                        <div className="grid grid-cols-1 gap-6">
                          <div className="flex flex-col gap-4">
                            ...
                            <textarea
                              id="more-info"
                              className="input-field w-full p-6 rounded-md bg-[#111119] text-sm leading-[29.05px] text-white opacity-80 resize-none"
                              rows={5}
                      ...
                      <div className="flex flex-col items-center py-10 gap-8">
                        <button onClick={() => setOpen(true)} className="px-20 bg-gradient-to-tl rounded-2xl from-[rgba(51,50,50,0.25)] via-[rgba(253,45,125,0.55)] to-[rgba(164,153,153,0.75)]">
                          <h1 className="text-lg font-normal leading-[21.78px] text-white  bg-transparent py-4">
                          Verify Otp
                          </h1>
                        </button>
...
{open && (
        <div className="fixed inset-0 z-50 flex  items-center justify-center">
          ...
          <div className="relative bg-[rgba(13,13,19,1)] rounded-[30px]  p-8 border-[1px] border-[rgba(255,255,255,0.11)] max-w-[340px] ">
            <div className="flex flex-col items-center w-full">
              ...
              <input
                ...
                className="bg-rgba(255,255,255,0.04) rounded-lg text-white py-4 px-6  mb-4 w-[100%]"
              />
