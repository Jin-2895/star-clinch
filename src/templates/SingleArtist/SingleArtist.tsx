  ...
  return (
    <Section>
      <div className="flex flex-col justify-start w-full mx-auto  ">
        <div className="flex flex-col items-center justify-center mx-auto w-full mt-[120px] gap-10">
          <div className="flex flex-col gap-4 items-center justify-center">
            ...
            <p className="text-[24px] font-normal leading-[29.05px] text-white transition-all duration-400">
              ...
              {data?.artist_list?.length ? data?.artist_list?.length - 1 : ""}+{" "}
              {data?.category?.name}
            </p>
          </div>
          <div className="flex flex-col gap-14 lg:gap-14">
            <div className="flex gap-1 ml-2 lg-gap-8">
              <FilterButton num={1} />
              <FilterButton num={2} />
              <FilterButton num={3} />
              <FilterButton num={4} />
        ...
        <div className="w-full max-w-[1660px] mx-auto grid md:grid-cols-2 xl:grid-cols-3 justify-between justify-items-center my-20 gap-4">
